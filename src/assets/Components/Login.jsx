            ...
            <>
                <form 
                    ...
                    className="userContainer h-[45px] min-w-[290px] w-[400px] bg-transparent relative max-w-[80%] mx-auto ">
                        <label 
                            htmlFor="username" 
                            className={`label font-ubuntu absolute  transition-all duration-150 left-3   -translate-y-1/2  ${user?.username ? "top-0 bg-white text-orange-400 font-semibold text-[15px]" : "top-1/2 bg-transparent text-slate-600 text-[16px]" }`}>
                                Username
                        </label>
                        <input
                    ...
                    className="passwordContainer h-[45px] min-w-[290px] w-[400px] bg-transparent relative  max-w-[80%] mx-auto ">
                        <label 
                            htmlFor="password" 
                            className={`label absolute font-ubuntu  transition-all duration-150 left-3   -translate-y-1/2  ${user?.password ? "top-0 bg-white  text-orange-400 font-semibold text-[15px]" : "top-1/2 bg-transparent text-slate-600 text-[16px]" }`}>
                                Password
                        </label>
                        <input
                            onChange={changeUserDetails}
