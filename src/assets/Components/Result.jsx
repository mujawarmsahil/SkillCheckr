...
export default function Result() {
    const studentData = [
        { studentId: 1, subjectId: 101, marksObtained: 75, totalMarks: 100, status: "Pass" },
        { studentId: 2, subjectId: 101, marksObtained: 45, totalMarks: 100, status: "Fail" },
        { studentId: 3, subjectId: 102, marksObtained: 85, totalMarks: 100, status: "Pass" },
    ];
